		...
		<div class="row justify-content-center">
			<form action="proveedorServlet" method="POST" class="col-8">
				...
				<div class="form-group">
					<label for="inputFirstName">Nombre proveedor</label> <input type="text"
						class="form-control" id="inputFirstName"
						placeholder="Ingresar nombre proveedor" name="nombreProv">
				</div>
				<div class="form-group">
					<label for="inputLastName">Apellido proveedor</label> <input type="text"
				...
				<div class="form-group">
					<label for="inputTel">Telefono</label> <input type="text"
						...
						placeholder="Ingresar telefono" name="telProv">
				</div>
