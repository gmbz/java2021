...
|CU NO-ABMC|1|2|creacion de pedidos|
|Listado simple|1|3(*)|lista de productos, lista de clientes, etc|
|Listado complejo|0|1(*)|lista pedidos filtrados por cliente|
...
|:-|:-|
|Manejo de archivos|generacion de xlsx|
|Custom exceptions||
|Log de errores||
